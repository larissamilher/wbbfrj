            ...
            ">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white">
                            <td class="px-4 py-4 whitespace-nowrap text-xs text-gray-900">
                                <strong>Data de validade: 
                                </strong> {{ date("d/m/Y", strtotime( $inscricao->validade_filiacao))}}
                            </td>                
                        </tr>
                        ...
                        <tr class="bg-white">
                            <td class="px-4 py-4 whitespace-nowrap text-xs text-gray-900">
                                <strong>Aceito os termos de atleta após ler atentamente: </strong>
                                {{($inscricao->atleta->termos_atleta)? 'Sim' : 'Não'}}
                            </td>                      
                        </tr>
