            ...
            <div class="row justify-content-end">
                <div class="col-xl-12 col-lg-12">
                    <div class="form-wrapper">
                        ...
                        <!--End Section Tittle  -->
                        <form id="inscricao-form" class="inscricao-form" action="{{ route('filiacao.pagamento') }}"  method="POST" style=" padding-top: 0;">
                            @csrf
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="row" style=" margin-top: 15%; ">
                                        ...
                                        <div class="col-lg-12 col-md-12 resumo-compra">
                                            ...
                                            <h1 id="label-valor-compra">R$ {{  number_format( $filiacao->valor, 2, ',', '.')}}</h1>
                                        </div>      
                                    </div>
                                </div>   
                                <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="col-lg-12 col-md-12" style=" margin-bottom: 3%;">
                                            <div class="form-box email-icon mb-30">
                                                ...
                                                <select name="parcelamento" id="parcelamento">
                                                    <option value="1" selected data-valor="{{  number_format( $filiacao->valor, 2, ',', '.')}}"> 
                                                        1 x R${{  number_format( $filiacao->valor, 2, ',', '.')}} *sem juros
                                                    </option>
                                                    @for($i = 2; $i <= 6; $i++)
                                                        <option value="{{ $i }}" data-valor="{{ $i }} * {{ number_format(($filiacao->valor + ($filiacao->valor * 0.0349 + 0.49)) / $i, 2, '.', '.') }}">
                                                            {{ $i }} x R${{ number_format(($filiacao->valor + ($filiacao->valor * 0.0349 + 0.49)) / $i, 2, '.', '.') }} *com juros
                                                        </option>
                                                    @endfor
                                                </select>                                                
                                            </div>
