        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/wbbf.png" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="assets/img/logo/wbbf-circulo.png" alt="" style="max-width: 60px;"></a>
                            </div>
                        </div>
                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="quem-somos.html">Quem Somos</a>
                                                <ul class="submenu">
                                                    <li><a href="comissao.html">Comissão Diretiva </a></li>
                                                </ul>
                                            </li>
                                            <li><a href="filiacao.html">Filiação</a></li>
                                            <li><a href="">Campeonatos</a>
                                                <ul class="submenu">
                                                    <li><a href="calendario.html">Calendário</a></li>
                                                    <li><a href="como-competir.html">Como competir na WBBF </a></li>
                                                    <li><a href="backstage-anual.html">Backstage Anual </a></li>
                                                    <li><a href="inscricao.html">Inscrições</a></li>
                                                    <li><a href="">Resultados</a>
                                                        <ul class="submenu">
                                                            <li><a href="resultado-2023.html">2023</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="assets/img/logo/wbbf.png" alt=""></a>
                                </div>
                                <div class="footer-tittle">
